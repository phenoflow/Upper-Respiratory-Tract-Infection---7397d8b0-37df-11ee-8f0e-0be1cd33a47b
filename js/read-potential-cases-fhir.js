...
(async () => {
  ...
  await fs.writeFile("upper-respiratory-tract-infection-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("upper-respiratory-tract-infection-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
